 ...
 *
 * NOTE: R2 currently has no /thumb/ variants, so we serve the
 * /content/ originals directly.  When optimize-images.mjs starts
 * uploading thumb/ to R2, re-enable the path swap below.
 *
...
export function getCdnThumbUrl(originalPath) {
  ...
  // Serve content/ originals directly (thumb/ doesn't exist in R2 yet)
  let key = originalPath
  // Future: uncomment when thumbs are uploaded to R2
